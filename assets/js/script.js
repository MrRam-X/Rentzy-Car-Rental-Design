document.addEventListener("DOMContentLoaded", function () {
  ...
  //     warning: `<svg class="w-6 h-6 text-brand-gold" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.21 3.03-1.742 3.03H4.42c-1.532 0-2.492-1.696-1.742-3.03l5.58-9.92zM10 5a1 1 0 011 1v3a1 1 0 11-2 0V6a1 1 0 011-1zm1 5a1 1 0 10-2 0v2a1 1 0 102 0v-2z" clip-rule="evenodd" /></svg>`,
  ...
  //   toast.className =
  //     "w-full bg-white rounded-lg shadow-lg p-4 flex items-start gap-3 toast-enter";

  //   toast.innerHTML = `
  //       <div class="flex-shrink-0">${icons[type]}</div>
  //       <div class="flex-grow">
  //           <p class="font-bold ${colors[type]}">${title}</p>
  //           <p class="text-sm text-gray-600 mt-1">${message}</p>
  //       </div>
  //       <div class="flex-shrink-0">
  //           <button class="toast-close-btn text-gray-400 hover:text-gray-600">
